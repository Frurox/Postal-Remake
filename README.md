...
<img src="https://github.com/Frurox/Postal-Remake/blob/main/Media/Postal-Remake.png?raw=true" width="100" height="100" alt="Postal Icon" />
...
|---|---|---|
| Retail (Midnight) | 120005 | ✅ Primary target |
...
| Mists of Pandaria Anniversary | 50503 | ✅ Supported |
...
1. Search for **Postal-Remake** on [CurseForge](https://www.curseforge.com/wow/addons/postal-remake) or [Wago Addons](https://addons.wago.io/addons/postal-remake).
...
1. Download the latest release from [GitHub Releases](https://github.com/Frurox/Postal-Remake/releases).
2. Extract the folder into your WoW AddOns directory. For Retail:
   ```
   World of Warcraft/_retail_/Interface/AddOns/Postal-Remake/
   ```
...
Please report issues on the [GitHub Issues](https://github.com/Frurox/Postal-Remake/issues) page. When reporting bugs, include:
